...
public static class Helpers
{
  ...
  ///// </summary>
  //[Obsolete("this is handled on the flavors now....")]
  //public static QueryParams CreateParams(string flavor, string queryType, object fromInstance, bool includeNulls = false, bool includeID = false)
  //{
  ...
  //        continue;
  //      }
  //      res.Add(item.Name, new QueryParamValue()
  //      {
  //      Value  = useVal,
  //      DataType = ClankerCode.DbTypeMapper.ToDbType(item.PropertyType, flavor)
  //      });
  //    }
  //  }
